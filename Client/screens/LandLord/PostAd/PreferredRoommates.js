...
class PreferredRoommates extends Component {
    render() {
        return (
            <View>
                <View>
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.margin}>
                        <Text style={styles.title}>Preferred Gender</Text>
                    ...
                    <View style={styles.margin}>
                        <View style={[CustomStyle.flex, CustomStyle.spaceBetween]}>
                            <Text style={{ fontSize: 18 }}>Preferred Age</Text>
                    ...
                    <View style={styles.margin}>
                        <Text style={styles.title}>Preferred Occupation</Text>
                        <View style={[CustomStyle.flex, CustomStyle.justifyBetween, styles.margin]}>
...
export default PreferredRoommates;